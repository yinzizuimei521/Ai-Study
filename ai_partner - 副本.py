...
import base64
print('------>重新执行，渲染展示页面')
SESSIONS_DIR = Path(r"E:\Python文件\Ai应用\sessions")
CHAT_BACKGROUND_IMAGE = Path(r"E:\Edge下载内容\downloaded-image.jpg")
st.set_page_config(
    page_title="我们的重制人生",           
    page_icon="🧊",                     
    layout="wide",
...
SKILL_OPTIONS = {
    "sora_ginko": {
        "name": "空银子",
        "path": Path(r"E:\Python文件\GalgameCharacterSkills\resource\叙事心理学分析_空银子_merged_summaries"),
    },
    "kawasegawa_eiko": {
        "name": "河濑川英子",
        "path": Path(r"E:\Python文件\GalgameCharacterSkills\resource\河濑川英子_skill"),
    },
    "chitose_saku": {
        "name": "上野原彩乃",
        "path": Path(r"E:\Python文件\上野原彩乃_skill"),
    },
    "shino_aki": {
        "name": "志野亚贵",
        "path": Path(r"E:\Python文件\GalgameCharacterSkills\resource\志野亚贵_skill"),
    },
    "hashiba_kyoya": {
        "name": "桥场恭也",
        "path": Path(r"E:\Python文件\GalgameCharacterSkills\resource\桥场恭也_skilll"),
    },
    "kogure_nanako": {
        "name": "小暮奈奈子",
        "path": Path(r"E:\Python文件\GalgameCharacterSkills\resource\小暮奈奈子_skill"),
    },
    "rokuonji_tsurayuki": {
        "name": "鹿苑寺贯之",
        "path": Path(r"E:\Python文件\GalgameCharacterSkills\resource\鹿苑寺贯之_skill"),
    },
}
...
def apply_chat_background():
    ...
    if not image_data:
        st.warning("聊天背景图片没有读取成功，请检查 E:\\Edge下载内容\\downloaded-image.jpg 是否存在。")
        return
...
st.logo(r"E:\Python文件\Ai应用\图片\Bokutachi_no_Remake_Logo.png", size="large")
